...
;
; RV32IXQCILI-SMALL-LABEL: below_threshold:
; RV32IXQCILI-SMALL:       # %bb.0: # %entry
; RV32IXQCILI-SMALL-NEXT:    li a2, 2
; RV32IXQCILI-SMALL-NEXT:    blt a2, a0, .LBB0_4
; RV32IXQCILI-SMALL-NEXT:  # %bb.1: # %entry
; RV32IXQCILI-SMALL-NEXT:    addi a2, a0, -1
; RV32IXQCILI-SMALL-NEXT:    beqz a2, .LBB0_7
; RV32IXQCILI-SMALL-NEXT:  # %bb.2: # %entry
; RV32IXQCILI-SMALL-NEXT:    addi a0, a0, -2
; RV32IXQCILI-SMALL-NEXT:    bnez a0, .LBB0_10
; RV32IXQCILI-SMALL-NEXT:  # %bb.3: # %bb2
; RV32IXQCILI-SMALL-NEXT:    li a0, 3
; RV32IXQCILI-SMALL-NEXT:    j .LBB0_9
; RV32IXQCILI-SMALL-NEXT:  .LBB0_4: # %entry
; RV32IXQCILI-SMALL-NEXT:    addi a2, a0, -3
; RV32IXQCILI-SMALL-NEXT:    beqz a2, .LBB0_8
; RV32IXQCILI-SMALL-NEXT:  # %bb.5: # %entry
; RV32IXQCILI-SMALL-NEXT:    addi a0, a0, -4
; RV32IXQCILI-SMALL-NEXT:    bnez a0, .LBB0_10
; RV32IXQCILI-SMALL-NEXT:  # %bb.6: # %bb4
; RV32IXQCILI-SMALL-NEXT:    li a0, 1
; RV32IXQCILI-SMALL-NEXT:    j .LBB0_9
; RV32IXQCILI-SMALL-NEXT:  .LBB0_7: # %bb1
; RV32IXQCILI-SMALL-NEXT:    li a0, 4
; RV32IXQCILI-SMALL-NEXT:    j .LBB0_9
; RV32IXQCILI-SMALL-NEXT:  .LBB0_8: # %bb3
; RV32IXQCILI-SMALL-NEXT:    li a0, 2
; RV32IXQCILI-SMALL-NEXT:  .LBB0_9: # %exit
; RV32IXQCILI-SMALL-NEXT:    sw a0, 0(a1)
; RV32IXQCILI-SMALL-NEXT:  .LBB0_10: # %exit
...
;
; RV32I-PIC-LABEL: below_threshold:
; RV32I-PIC:       # %bb.0: # %entry
; RV32I-PIC-NEXT:    li a2, 2
; RV32I-PIC-NEXT:    blt a2, a0, .LBB0_4
; RV32I-PIC-NEXT:  # %bb.1: # %entry
; RV32I-PIC-NEXT:    li a2, 1
; RV32I-PIC-NEXT:    beq a0, a2, .LBB0_7
; RV32I-PIC-NEXT:  # %bb.2: # %entry
; RV32I-PIC-NEXT:    li a2, 2
; RV32I-PIC-NEXT:    bne a0, a2, .LBB0_10
; RV32I-PIC-NEXT:  # %bb.3: # %bb2
; RV32I-PIC-NEXT:    li a0, 3
; RV32I-PIC-NEXT:    j .LBB0_9
; RV32I-PIC-NEXT:  .LBB0_4: # %entry
; RV32I-PIC-NEXT:    li a2, 3
; RV32I-PIC-NEXT:    beq a0, a2, .LBB0_8
; RV32I-PIC-NEXT:  # %bb.5: # %entry
; RV32I-PIC-NEXT:    li a2, 4
; RV32I-PIC-NEXT:    bne a0, a2, .LBB0_10
; RV32I-PIC-NEXT:  # %bb.6: # %bb4
; RV32I-PIC-NEXT:    li a0, 1
; RV32I-PIC-NEXT:    j .LBB0_9
; RV32I-PIC-NEXT:  .LBB0_7: # %bb1
; RV32I-PIC-NEXT:    li a0, 4
; RV32I-PIC-NEXT:    j .LBB0_9
; RV32I-PIC-NEXT:  .LBB0_8: # %bb3
; RV32I-PIC-NEXT:    li a0, 2
; RV32I-PIC-NEXT:  .LBB0_9: # %exit
; RV32I-PIC-NEXT:    sw a0, 0(a1)
; RV32I-PIC-NEXT:  .LBB0_10: # %exit
; RV32I-PIC-NEXT:    ret
;
...
;
; RV64I-PIC-LABEL: below_threshold:
; RV64I-PIC:       # %bb.0: # %entry
; RV64I-PIC-NEXT:    li a2, 2
; RV64I-PIC-NEXT:    blt a2, a0, .LBB0_4
; RV64I-PIC-NEXT:  # %bb.1: # %entry
; RV64I-PIC-NEXT:    li a2, 1
; RV64I-PIC-NEXT:    beq a0, a2, .LBB0_7
; RV64I-PIC-NEXT:  # %bb.2: # %entry
; RV64I-PIC-NEXT:    li a2, 2
; RV64I-PIC-NEXT:    bne a0, a2, .LBB0_10
; RV64I-PIC-NEXT:  # %bb.3: # %bb2
; RV64I-PIC-NEXT:    li a0, 3
; RV64I-PIC-NEXT:    j .LBB0_9
; RV64I-PIC-NEXT:  .LBB0_4: # %entry
; RV64I-PIC-NEXT:    li a2, 3
; RV64I-PIC-NEXT:    beq a0, a2, .LBB0_8
; RV64I-PIC-NEXT:  # %bb.5: # %entry
; RV64I-PIC-NEXT:    li a2, 4
; RV64I-PIC-NEXT:    bne a0, a2, .LBB0_10
; RV64I-PIC-NEXT:  # %bb.6: # %bb4
; RV64I-PIC-NEXT:    li a0, 1
; RV64I-PIC-NEXT:    j .LBB0_9
; RV64I-PIC-NEXT:  .LBB0_7: # %bb1
; RV64I-PIC-NEXT:    li a0, 4
; RV64I-PIC-NEXT:    j .LBB0_9
; RV64I-PIC-NEXT:  .LBB0_8: # %bb3
; RV64I-PIC-NEXT:    li a0, 2
; RV64I-PIC-NEXT:  .LBB0_9: # %exit
; RV64I-PIC-NEXT:    sw a0, 0(a1)
; RV64I-PIC-NEXT:  .LBB0_10: # %exit
; RV64I-PIC-NEXT:    ret
;
; RV32I-SMALL-7-ENTRIES-LABEL: below_threshold:
; RV32I-SMALL-7-ENTRIES:       # %bb.0: # %entry
; RV32I-SMALL-7-ENTRIES-NEXT:    li a2, 2
; RV32I-SMALL-7-ENTRIES-NEXT:    blt a2, a0, .LBB0_4
; RV32I-SMALL-7-ENTRIES-NEXT:  # %bb.1: # %entry
; RV32I-SMALL-7-ENTRIES-NEXT:    li a2, 1
; RV32I-SMALL-7-ENTRIES-NEXT:    beq a0, a2, .LBB0_7
; RV32I-SMALL-7-ENTRIES-NEXT:  # %bb.2: # %entry
; RV32I-SMALL-7-ENTRIES-NEXT:    li a2, 2
; RV32I-SMALL-7-ENTRIES-NEXT:    bne a0, a2, .LBB0_10
; RV32I-SMALL-7-ENTRIES-NEXT:  # %bb.3: # %bb2
; RV32I-SMALL-7-ENTRIES-NEXT:    li a0, 3
; RV32I-SMALL-7-ENTRIES-NEXT:    j .LBB0_9
; RV32I-SMALL-7-ENTRIES-NEXT:  .LBB0_4: # %entry
; RV32I-SMALL-7-ENTRIES-NEXT:    li a2, 3
; RV32I-SMALL-7-ENTRIES-NEXT:    beq a0, a2, .LBB0_8
; RV32I-SMALL-7-ENTRIES-NEXT:  # %bb.5: # %entry
; RV32I-SMALL-7-ENTRIES-NEXT:    li a2, 4
; RV32I-SMALL-7-ENTRIES-NEXT:    bne a0, a2, .LBB0_10
; RV32I-SMALL-7-ENTRIES-NEXT:  # %bb.6: # %bb4
; RV32I-SMALL-7-ENTRIES-NEXT:    li a0, 1
; RV32I-SMALL-7-ENTRIES-NEXT:    j .LBB0_9
; RV32I-SMALL-7-ENTRIES-NEXT:  .LBB0_7: # %bb1
; RV32I-SMALL-7-ENTRIES-NEXT:    li a0, 4
; RV32I-SMALL-7-ENTRIES-NEXT:    j .LBB0_9
; RV32I-SMALL-7-ENTRIES-NEXT:  .LBB0_8: # %bb3
; RV32I-SMALL-7-ENTRIES-NEXT:    li a0, 2
; RV32I-SMALL-7-ENTRIES-NEXT:  .LBB0_9: # %exit
; RV32I-SMALL-7-ENTRIES-NEXT:    sw a0, 0(a1)
; RV32I-SMALL-7-ENTRIES-NEXT:  .LBB0_10: # %exit
; RV32I-SMALL-7-ENTRIES-NEXT:    ret
;
; RV32IXQCILI-SMALL-7-ENTRIES-LABEL: below_threshold:
; RV32IXQCILI-SMALL-7-ENTRIES:       # %bb.0: # %entry
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    li a2, 2
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    blt a2, a0, .LBB0_4
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:  # %bb.1: # %entry
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    addi a2, a0, -1
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    beqz a2, .LBB0_7
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:  # %bb.2: # %entry
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    addi a0, a0, -2
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    bnez a0, .LBB0_10
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:  # %bb.3: # %bb2
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    li a0, 3
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    j .LBB0_9
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:  .LBB0_4: # %entry
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    addi a2, a0, -3
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    beqz a2, .LBB0_8
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:  # %bb.5: # %entry
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    addi a0, a0, -4
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    bnez a0, .LBB0_10
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:  # %bb.6: # %bb4
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    li a0, 1
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    j .LBB0_9
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:  .LBB0_7: # %bb1
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    li a0, 4
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    j .LBB0_9
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:  .LBB0_8: # %bb3
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    li a0, 2
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:  .LBB0_9: # %exit
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    sw a0, 0(a1)
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:  .LBB0_10: # %exit
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    ret
;
; RV32I-MEDIUM-7-ENTRIES-LABEL: below_threshold:
; RV32I-MEDIUM-7-ENTRIES:       # %bb.0: # %entry
; RV32I-MEDIUM-7-ENTRIES-NEXT:    li a2, 2
; RV32I-MEDIUM-7-ENTRIES-NEXT:    blt a2, a0, .LBB0_4
; RV32I-MEDIUM-7-ENTRIES-NEXT:  # %bb.1: # %entry
; RV32I-MEDIUM-7-ENTRIES-NEXT:    li a2, 1
; RV32I-MEDIUM-7-ENTRIES-NEXT:    beq a0, a2, .LBB0_7
; RV32I-MEDIUM-7-ENTRIES-NEXT:  # %bb.2: # %entry
; RV32I-MEDIUM-7-ENTRIES-NEXT:    li a2, 2
; RV32I-MEDIUM-7-ENTRIES-NEXT:    bne a0, a2, .LBB0_10
; RV32I-MEDIUM-7-ENTRIES-NEXT:  # %bb.3: # %bb2
; RV32I-MEDIUM-7-ENTRIES-NEXT:    li a0, 3
; RV32I-MEDIUM-7-ENTRIES-NEXT:    j .LBB0_9
; RV32I-MEDIUM-7-ENTRIES-NEXT:  .LBB0_4: # %entry
; RV32I-MEDIUM-7-ENTRIES-NEXT:    li a2, 3
; RV32I-MEDIUM-7-ENTRIES-NEXT:    beq a0, a2, .LBB0_8
; RV32I-MEDIUM-7-ENTRIES-NEXT:  # %bb.5: # %entry
; RV32I-MEDIUM-7-ENTRIES-NEXT:    li a2, 4
; RV32I-MEDIUM-7-ENTRIES-NEXT:    bne a0, a2, .LBB0_10
; RV32I-MEDIUM-7-ENTRIES-NEXT:  # %bb.6: # %bb4
; RV32I-MEDIUM-7-ENTRIES-NEXT:    li a0, 1
; RV32I-MEDIUM-7-ENTRIES-NEXT:    j .LBB0_9
; RV32I-MEDIUM-7-ENTRIES-NEXT:  .LBB0_7: # %bb1
; RV32I-MEDIUM-7-ENTRIES-NEXT:    li a0, 4
; RV32I-MEDIUM-7-ENTRIES-NEXT:    j .LBB0_9
; RV32I-MEDIUM-7-ENTRIES-NEXT:  .LBB0_8: # %bb3
; RV32I-MEDIUM-7-ENTRIES-NEXT:    li a0, 2
; RV32I-MEDIUM-7-ENTRIES-NEXT:  .LBB0_9: # %exit
; RV32I-MEDIUM-7-ENTRIES-NEXT:    sw a0, 0(a1)
; RV32I-MEDIUM-7-ENTRIES-NEXT:  .LBB0_10: # %exit
; RV32I-MEDIUM-7-ENTRIES-NEXT:    ret
;
; RV32I-PIC-7-ENTRIES-LABEL: below_threshold:
; RV32I-PIC-7-ENTRIES:       # %bb.0: # %entry
; RV32I-PIC-7-ENTRIES-NEXT:    li a2, 2
; RV32I-PIC-7-ENTRIES-NEXT:    blt a2, a0, .LBB0_4
; RV32I-PIC-7-ENTRIES-NEXT:  # %bb.1: # %entry
; RV32I-PIC-7-ENTRIES-NEXT:    li a2, 1
; RV32I-PIC-7-ENTRIES-NEXT:    beq a0, a2, .LBB0_7
; RV32I-PIC-7-ENTRIES-NEXT:  # %bb.2: # %entry
; RV32I-PIC-7-ENTRIES-NEXT:    li a2, 2
; RV32I-PIC-7-ENTRIES-NEXT:    bne a0, a2, .LBB0_10
; RV32I-PIC-7-ENTRIES-NEXT:  # %bb.3: # %bb2
; RV32I-PIC-7-ENTRIES-NEXT:    li a0, 3
; RV32I-PIC-7-ENTRIES-NEXT:    j .LBB0_9
; RV32I-PIC-7-ENTRIES-NEXT:  .LBB0_4: # %entry
; RV32I-PIC-7-ENTRIES-NEXT:    li a2, 3
; RV32I-PIC-7-ENTRIES-NEXT:    beq a0, a2, .LBB0_8
; RV32I-PIC-7-ENTRIES-NEXT:  # %bb.5: # %entry
; RV32I-PIC-7-ENTRIES-NEXT:    li a2, 4
; RV32I-PIC-7-ENTRIES-NEXT:    bne a0, a2, .LBB0_10
; RV32I-PIC-7-ENTRIES-NEXT:  # %bb.6: # %bb4
; RV32I-PIC-7-ENTRIES-NEXT:    li a0, 1
; RV32I-PIC-7-ENTRIES-NEXT:    j .LBB0_9
; RV32I-PIC-7-ENTRIES-NEXT:  .LBB0_7: # %bb1
; RV32I-PIC-7-ENTRIES-NEXT:    li a0, 4
; RV32I-PIC-7-ENTRIES-NEXT:    j .LBB0_9
; RV32I-PIC-7-ENTRIES-NEXT:  .LBB0_8: # %bb3
; RV32I-PIC-7-ENTRIES-NEXT:    li a0, 2
; RV32I-PIC-7-ENTRIES-NEXT:  .LBB0_9: # %exit
; RV32I-PIC-7-ENTRIES-NEXT:    sw a0, 0(a1)
; RV32I-PIC-7-ENTRIES-NEXT:  .LBB0_10: # %exit
; RV32I-PIC-7-ENTRIES-NEXT:    ret
;
; RV64I-SMALL-7-ENTRIES-LABEL: below_threshold:
; RV64I-SMALL-7-ENTRIES:       # %bb.0: # %entry
; RV64I-SMALL-7-ENTRIES-NEXT:    li a2, 2
; RV64I-SMALL-7-ENTRIES-NEXT:    blt a2, a0, .LBB0_4
; RV64I-SMALL-7-ENTRIES-NEXT:  # %bb.1: # %entry
; RV64I-SMALL-7-ENTRIES-NEXT:    li a2, 1
; RV64I-SMALL-7-ENTRIES-NEXT:    beq a0, a2, .LBB0_7
; RV64I-SMALL-7-ENTRIES-NEXT:  # %bb.2: # %entry
; RV64I-SMALL-7-ENTRIES-NEXT:    li a2, 2
; RV64I-SMALL-7-ENTRIES-NEXT:    bne a0, a2, .LBB0_10
; RV64I-SMALL-7-ENTRIES-NEXT:  # %bb.3: # %bb2
; RV64I-SMALL-7-ENTRIES-NEXT:    li a0, 3
; RV64I-SMALL-7-ENTRIES-NEXT:    j .LBB0_9
; RV64I-SMALL-7-ENTRIES-NEXT:  .LBB0_4: # %entry
; RV64I-SMALL-7-ENTRIES-NEXT:    li a2, 3
; RV64I-SMALL-7-ENTRIES-NEXT:    beq a0, a2, .LBB0_8
; RV64I-SMALL-7-ENTRIES-NEXT:  # %bb.5: # %entry
; RV64I-SMALL-7-ENTRIES-NEXT:    li a2, 4
; RV64I-SMALL-7-ENTRIES-NEXT:    bne a0, a2, .LBB0_10
; RV64I-SMALL-7-ENTRIES-NEXT:  # %bb.6: # %bb4
; RV64I-SMALL-7-ENTRIES-NEXT:    li a0, 1
; RV64I-SMALL-7-ENTRIES-NEXT:    j .LBB0_9
; RV64I-SMALL-7-ENTRIES-NEXT:  .LBB0_7: # %bb1
; RV64I-SMALL-7-ENTRIES-NEXT:    li a0, 4
; RV64I-SMALL-7-ENTRIES-NEXT:    j .LBB0_9
; RV64I-SMALL-7-ENTRIES-NEXT:  .LBB0_8: # %bb3
; RV64I-SMALL-7-ENTRIES-NEXT:    li a0, 2
; RV64I-SMALL-7-ENTRIES-NEXT:  .LBB0_9: # %exit
; RV64I-SMALL-7-ENTRIES-NEXT:    sw a0, 0(a1)
; RV64I-SMALL-7-ENTRIES-NEXT:  .LBB0_10: # %exit
; RV64I-SMALL-7-ENTRIES-NEXT:    ret
;
; RV64I-MEDIUM-7-ENTRIES-LABEL: below_threshold:
; RV64I-MEDIUM-7-ENTRIES:       # %bb.0: # %entry
; RV64I-MEDIUM-7-ENTRIES-NEXT:    li a2, 2
; RV64I-MEDIUM-7-ENTRIES-NEXT:    blt a2, a0, .LBB0_4
; RV64I-MEDIUM-7-ENTRIES-NEXT:  # %bb.1: # %entry
; RV64I-MEDIUM-7-ENTRIES-NEXT:    li a2, 1
; RV64I-MEDIUM-7-ENTRIES-NEXT:    beq a0, a2, .LBB0_7
; RV64I-MEDIUM-7-ENTRIES-NEXT:  # %bb.2: # %entry
; RV64I-MEDIUM-7-ENTRIES-NEXT:    li a2, 2
; RV64I-MEDIUM-7-ENTRIES-NEXT:    bne a0, a2, .LBB0_10
; RV64I-MEDIUM-7-ENTRIES-NEXT:  # %bb.3: # %bb2
; RV64I-MEDIUM-7-ENTRIES-NEXT:    li a0, 3
; RV64I-MEDIUM-7-ENTRIES-NEXT:    j .LBB0_9
; RV64I-MEDIUM-7-ENTRIES-NEXT:  .LBB0_4: # %entry
; RV64I-MEDIUM-7-ENTRIES-NEXT:    li a2, 3
; RV64I-MEDIUM-7-ENTRIES-NEXT:    beq a0, a2, .LBB0_8
; RV64I-MEDIUM-7-ENTRIES-NEXT:  # %bb.5: # %entry
; RV64I-MEDIUM-7-ENTRIES-NEXT:    li a2, 4
; RV64I-MEDIUM-7-ENTRIES-NEXT:    bne a0, a2, .LBB0_10
; RV64I-MEDIUM-7-ENTRIES-NEXT:  # %bb.6: # %bb4
; RV64I-MEDIUM-7-ENTRIES-NEXT:    li a0, 1
; RV64I-MEDIUM-7-ENTRIES-NEXT:    j .LBB0_9
; RV64I-MEDIUM-7-ENTRIES-NEXT:  .LBB0_7: # %bb1
; RV64I-MEDIUM-7-ENTRIES-NEXT:    li a0, 4
; RV64I-MEDIUM-7-ENTRIES-NEXT:    j .LBB0_9
; RV64I-MEDIUM-7-ENTRIES-NEXT:  .LBB0_8: # %bb3
; RV64I-MEDIUM-7-ENTRIES-NEXT:    li a0, 2
; RV64I-MEDIUM-7-ENTRIES-NEXT:  .LBB0_9: # %exit
; RV64I-MEDIUM-7-ENTRIES-NEXT:    sw a0, 0(a1)
; RV64I-MEDIUM-7-ENTRIES-NEXT:  .LBB0_10: # %exit
; RV64I-MEDIUM-7-ENTRIES-NEXT:    ret
;
; RV64I-PIC-7-ENTRIES-LABEL: below_threshold:
; RV64I-PIC-7-ENTRIES:       # %bb.0: # %entry
; RV64I-PIC-7-ENTRIES-NEXT:    li a2, 2
; RV64I-PIC-7-ENTRIES-NEXT:    blt a2, a0, .LBB0_4
; RV64I-PIC-7-ENTRIES-NEXT:  # %bb.1: # %entry
; RV64I-PIC-7-ENTRIES-NEXT:    li a2, 1
; RV64I-PIC-7-ENTRIES-NEXT:    beq a0, a2, .LBB0_7
; RV64I-PIC-7-ENTRIES-NEXT:  # %bb.2: # %entry
; RV64I-PIC-7-ENTRIES-NEXT:    li a2, 2
; RV64I-PIC-7-ENTRIES-NEXT:    bne a0, a2, .LBB0_10
; RV64I-PIC-7-ENTRIES-NEXT:  # %bb.3: # %bb2
; RV64I-PIC-7-ENTRIES-NEXT:    li a0, 3
; RV64I-PIC-7-ENTRIES-NEXT:    j .LBB0_9
; RV64I-PIC-7-ENTRIES-NEXT:  .LBB0_4: # %entry
; RV64I-PIC-7-ENTRIES-NEXT:    li a2, 3
; RV64I-PIC-7-ENTRIES-NEXT:    beq a0, a2, .LBB0_8
; RV64I-PIC-7-ENTRIES-NEXT:  # %bb.5: # %entry
; RV64I-PIC-7-ENTRIES-NEXT:    li a2, 4
; RV64I-PIC-7-ENTRIES-NEXT:    bne a0, a2, .LBB0_10
; RV64I-PIC-7-ENTRIES-NEXT:  # %bb.6: # %bb4
; RV64I-PIC-7-ENTRIES-NEXT:    li a0, 1
; RV64I-PIC-7-ENTRIES-NEXT:    j .LBB0_9
; RV64I-PIC-7-ENTRIES-NEXT:  .LBB0_7: # %bb1
; RV64I-PIC-7-ENTRIES-NEXT:    li a0, 4
; RV64I-PIC-7-ENTRIES-NEXT:    j .LBB0_9
; RV64I-PIC-7-ENTRIES-NEXT:  .LBB0_8: # %bb3
; RV64I-PIC-7-ENTRIES-NEXT:    li a0, 2
; RV64I-PIC-7-ENTRIES-NEXT:  .LBB0_9: # %exit
; RV64I-PIC-7-ENTRIES-NEXT:    sw a0, 0(a1)
; RV64I-PIC-7-ENTRIES-NEXT:  .LBB0_10: # %exit
...
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:  # %bb.1: # %entry
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    addi a2, a0, -1
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    beqz a2, .LBB1_9
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:  # %bb.2: # %entry
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    addi a2, a0, -2
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    beqz a2, .LBB1_11
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:  # %bb.3: # %entry
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    addi a0, a0, -3
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    bnez a0, .LBB1_14
...
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    addi a2, a0, -4
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    beqz a2, .LBB1_10
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:  # %bb.6: # %entry
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    addi a2, a0, -5
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    beqz a2, .LBB1_12
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:  # %bb.7: # %entry
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    addi a0, a0, -6
; RV32IXQCILI-SMALL-7-ENTRIES-NEXT:    bnez a0, .LBB1_14
