# RUN: not llvm-mc %s -triple=riscv32 --mattr=+a 2>&1 | FileCheck %s
# RUN: not llvm-mc %s -triple=riscv64 --mattr=+a 2>&1 | FileCheck %s
...
lr.w a1, (f0)   # CHECK: :[[@LINE]]:11: error: operand must be a GPR with optional zero immediate
lr.w a1, 0(f0)  # CHECK: :[[@LINE]]:12: error: operand must be a GPR with optional zero immediate
...
sc.w a2, a1, (f0)   # CHECK: :[[@LINE]]:15: error: operand must be a GPR with optional zero immediate
sc.w a2, a1, 0(f0)  # CHECK: :[[@LINE]]:16: error: operand must be a GPR with optional zero immediate
...
amoswap.w a2, a1, (f0)   # CHECK: :[[@LINE]]:20: error: operand must be a GPR with optional zero immediate
amoswap.w a2, a1, 0(f0)  # CHECK: :[[@LINE]]:21: error: operand must be a GPR with optional zero immediate
...
amoadd.w a2, a1, (f0)   # CHECK: :[[@LINE]]:19: error: operand must be a GPR with optional zero immediate
amoadd.w a2, a1, 0(f0)  # CHECK: :[[@LINE]]:20: error: operand must be a GPR with optional zero immediate
...
amoxor.w a2, a1, (f0)   # CHECK: :[[@LINE]]:19: error: operand must be a GPR with optional zero immediate
amoxor.w a2, a1, 0(f0)  # CHECK: :[[@LINE]]:20: error: operand must be a GPR with optional zero immediate
...
amoand.w a2, a1, (f0)   # CHECK: :[[@LINE]]:19: error: operand must be a GPR with optional zero immediate
amoand.w a2, a1, 0(f0)  # CHECK: :[[@LINE]]:20: error: operand must be a GPR with optional zero immediate
...
amoor.w a2, a1, (f0)   # CHECK: :[[@LINE]]:18: error: operand must be a GPR with optional zero immediate
amoor.w a2, a1, 0(f0)  # CHECK: :[[@LINE]]:19: error: operand must be a GPR with optional zero immediate
...
amomin.w a2, a1, (f0)   # CHECK: :[[@LINE]]:19: error: operand must be a GPR with optional zero immediate
amomin.w a2, a1, 0(f0)  # CHECK: :[[@LINE]]:20: error: operand must be a GPR with optional zero immediate
...
amomax.w a2, a1, (f0)   # CHECK: :[[@LINE]]:19: error: operand must be a GPR with optional zero immediate
amomax.w a2, a1, 0(f0)  # CHECK: :[[@LINE]]:20: error: operand must be a GPR with optional zero immediate
...
amominu.w a2, a1, (f0)   # CHECK: :[[@LINE]]:20: error: operand must be a GPR with optional zero immediate
amominu.w a2, a1, 0(f0)  # CHECK: :[[@LINE]]:21: error: operand must be a GPR with optional zero immediate
...
amomaxu.w a2, a1, (f0)   # CHECK: :[[@LINE]]:20: error: operand must be a GPR with optional zero immediate
amomaxu.w a2, a1, 0(f0)  # CHECK: :[[@LINE]]:21: error: operand must be a GPR with optional zero immediate
