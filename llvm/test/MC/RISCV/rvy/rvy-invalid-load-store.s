...
#
.ifdef RV64
# CHECK-ASM-AND-OBJ-64: lwu	a0, 16(zero)
# CHECK-ASM-64-SAME: # encoding: [0x03,0x65,0x00,0x01]
# CHECK-CAP-MODE-DISASM-64-NEXT: 01006503 <unknown>
# ERR-RVY-64: <stdin>:[[#@LINE+1]]:12: error: register must be a GPR excluding null (x0)
lwu a0, 16(zero)
# CHECK-ASM-AND-OBJ-64: ld	a0, 16(zero)
# CHECK-ASM-64-SAME: # encoding:  [0x03,0x35,0x00,0x01]
# CHECK-CAP-MODE-DISASM-64-NEXT: 01003503 <unknown>
# ERR-RVY-64: <stdin>:[[#@LINE+1]]:11: error: register must be a GPR excluding null (x0)
ld a0, 16(zero)
# CHECK-ASM-AND-OBJ-64: sd	a0, 16(zero)
