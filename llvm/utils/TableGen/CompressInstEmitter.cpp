...
bool CompressInstEmitter::validateRegister(const Record *Reg,
  ...
  const Record *RC = Target.getHwModes().resolveModeSelect(RegClass, PatPreds);
  const Record *R = Target.getHwModes().resolveModeSelect(Reg, PatPreds);
